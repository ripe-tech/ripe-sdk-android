...
open class Observable {
    val callbacks: MutableMap<String, ArrayList<(args: Map<String, Any>) -> Unit>> = HashMap()
    ...
    fun bind(event: String, callback: (args: Map<String, Any>) -> Unit) = removeCallback(event, callback)
